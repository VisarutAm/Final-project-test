...
const Footer = () => {
  return (
    <footer className="bg-white ">
      <div className="container mx-auto mb-10 md:px-20 mt-10">
        <div className="flex flex-col md:flex-row items-left justify-between">
          <div className=" flex items-center">
            ...
            <a href="/" className="ml-3 text-2xl font-bold text-blue-500">
              HomeServices
            </a>
          </div>
          <div className="px-4 text-sm text-left md:text-left mt-4 md:mt-0">
          ...
          <div className="px-4 text-sm text-left mt-4 md:mt-0">
            <div className="flex items-center">
